        ...
        <div class="sidebar">
            <div class="sidebar-inner">
                ...
                <ul class="sidebar-menu scrollable pos-r">
                    ...
                    <li class="nav-item"><a class="sidebar-link" href="#"><span class="icon-holder"><i class="c-brown-500 ti-email"></i> </span><span class="title">Actividades</span></a></li>
                                                          ...
                                                          <div class="modal-content">
                                                              ...
                                                              <div class="modal-body">
                                                                    ...
                                                                    <div>
                                                                          ...
                                                                          <div class="form-group">     
                                                                              <label for="exampleInputPassword1">FECHA & LUGAR</label>
                                                                              <input type="text" class="form-control" id="fecha" placeholder="">                                                                                                                                 

                                                                          </div>
                                                                          <div class="form-group">
                                                                              <label for="exampleInputPassword1">TEMA1</label>
                                                                              <input type="text" class="form-control" id="tema1" placeholder="">
                                                                          </div>
                                                                          <div class="form-group">
                                                                              <label for="exampleInputPassword1">TEMA2</label>
                                                                              <input type="text" class="form-control" id="tema2" placeholder="">
                                                                          </div>
                                                                          <div class="form-group">
                                                                              <label for="exampleInputPassword1">TEMA3</label>
                                                                              <input type="text" class="form-control" id="tema3" placeholder="">
                                                                          </div>
                                                                          <div class="form-group">
                                                                              <label for="exampleInputPassword1">TEMA4</label>
                                                                              <input type="text" class="form-control" id="tema4" placeholder="">
                                                                          </div>
                                                                          <div class="form-group">
                                                                              <label for="exampleInputPassword1">TEMA5</label>
                                                                              <input type="text" class="form-control" id="tema5" placeholder="">
                                                                          </div>
                                                                          <div class="form-group">
                                                              ...
                                                              <div class="modal-footer">
                                                                  ...
                                                                  <button id="actualizar"type="button" onclick="ActualizarActividad();" class="btn btn-primary ">Actualizar</button>
                                                                  <button id="registrar"type="button" onclick="RegistrarActividad();" class="btn btn-primary ">Registrar</button>
                                                              </div>
                                                          </div>
                                                      </div>
                                                  </div>
                                               ...
                                               // alert("actualizando");
                                                 ...
                                                 var parametros = {
                                                     // "id" : document.getElementById("id").value,
                                                      ...
                                                      "tema1":document.getElementById("tema1").value,
                                                      "tema2":document.getElementById("tema2").value,
                                                      "tema3":document.getElementById("tema3").value,
                                                      "tema4":document.getElementById("tema4").value,
                                                      "tema5":document.getElementById("tema5").value,
                                                      "tema6":document.getElementById("tema6").value,
                                                   ...
                                                   var opcion = confirm("Desea registrarla actividad  "+nombre+" ?");
                                                   if (opcion == true) {
                                                       $.ajax({
                                                            data:  parametros, //  connect.open('POST','?view=registro',true);
                                                            url:   '?view=InsertActividad', //archivo que recibe la peticion
                                                            type:  'post', //método de envio
                                                            beforeSend: function () {
                                                                   document.getElementById('_AJAX_').innerHTML='<div class="alert alert-success" role="alert">Procesando, espere por favor...</div>';
                                                            },
