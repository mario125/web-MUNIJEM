                                        ...
                                        <tbody>
                                         {foreach from=$posts item=tp}   
                                            <tr>
                                                ...
                                                <td>{$tp.fecha}</td>     
                                                <td>
                                                <button type="button" onclick="Editar({$tp.id},'{$tp.nombre}','{$tp.correo}','{$tp.nick}');"id="boton-edit"class="boton-edit btn cur-p btn-primary ti-pencil"data-toggle="modal" data-target="#exampleModal"></button>                                                
                                                <button type="button" onclick="Eliminar({$tp.id},'{$tp.nombre}');"class="boton-delete btn cur-p btn-danger ti-close"></button>
